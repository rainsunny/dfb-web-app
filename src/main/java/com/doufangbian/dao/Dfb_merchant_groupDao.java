...
public class Dfb_merchant_groupDao {
    ...
    private static Logger logger = Logger.getLogger(Dfb_merchant_groupDao.class);
...
//		}
     ...
     * @return
     */
    public boolean addGroup(String name, String areaID, String catId) {

        String sql = "insert into dfb_merchant_group(name, updatetime, cat_id) values(?, ?, ?)";

        String time = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date());

        logger.debug("execute sql: " + sql);

        return DBHelper.commonUpdate(sql, name, time, catId);
    }
